...
$sqln = mysql_query("SELECT * FROM anuncio ORDER BY id  LIMIT ".$inicio.",".$max."");
...
?>
  ...
  print '<tr bgcolor='.$cor.'>';
	...
	print '<td align="center"><font color="white">'.$local.'</font></td>';
	  print '<td align="center"><a href="atualagenda3.php?id='.$id.'"><img src="bt_atualizar.png" width="20"><br />Altualizar</a></td>';
  print '</tr>';
  print '<tr><td></td></tr>';
