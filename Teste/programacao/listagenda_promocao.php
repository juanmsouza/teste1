...
$sqln = mysql_query("SELECT * FROM promocao ORDER BY id DESC");
...
<form name="form1" action="listagenda_promocao.php" method="POST" style="padding-top:40px;" enctype="multipart/form-data">
<font color="#fffff">
<?php
...
<td colspan="2" align="center">Eventos promocaodos</td>
</tr>
<tr>
<td>
 ...
 print '<td align="center"><a href="atualagenda_promocao.php?id='.$id.'"><img src="bt_atualizar.png" width="20"><br />Altualizar</a></td>';
    print '<td align="center"><a href="deletagenda_promocao.php?id='.$id.'"><img src="excluir.jpg" width="20"><br />Excluir</a></td>';
...
print '<a href="listagenda_promocao.php?'. $_SERVER['QUERY_STRING']. "&pagina=".($pagina - 1).'"><< anterior</a>';
...
if ($total_paginas > 1){ 
    ...
    for ($i=1; $i <= $total_paginas; $i++){ 
       ...
       if ($pagina == $i){        
          ...
          echo "<a href=\"listagenda_promocao.php?" . $_SERVER['QUERY_STRING']."&pagina=".$i."\">&nbsp;".$i."&nbsp;</a> "; 
...
print '<a href="listagenda_promocao.php?'. $_SERVER['QUERY_STRING']. "&pagina=".($pagina + 1).'">próxima >></a>';
