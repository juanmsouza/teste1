...
if(isset($_POST['done'])){
    ...
    $conteudo = $_POST['desc'];
       ...
       $sql = mysql_query("UPDATE agenda SET evento='$evento', devento='$devento', mevento='$mevento', aevento='$aevento', hora='$hora',minuto='$minuto', local='$local', conteudo='$conteudo' WHERE id='$id'")or die(mysql_error());
...
<form name="form1" action="atualagenda_index.php" method="POST" style="padding-top:40px;">
...
<td colspan="4"><div align="center"><b>.:: Atualizar Agenda ::.</b></td>
...
<td><input type="submit" value="Atualizar Agenda" />
  ...
  <input type="button" name="button" id="button" onclick="javascript:location.href='listagenda_index.php';" value="Cancelar" />
