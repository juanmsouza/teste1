...
$situacao='A';
   ...
   $sql = mysql_query("INSERT INTO `promocao`(`evento`, `devento`,`mevento`,`aevento`,`hora`,`minuto`, `local`, `conteudo`, `situacao` ) VALUES ('$evento', '$devento', '$mevento', '$aevento', '$hora', '$minuto', '$local', '$conteudo', '$situacao')") or die(mysql_error());
            if($sql){
...
<form name="form1" action="agenda_promocao.php" method="POST" style="padding-top:40px;" enctype="multipart/form-data">
<font color="#fffff">
<?php
