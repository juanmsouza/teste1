...
$texto = ''.$t1.' '.$t2.' '.$t3.' '.$t4.' '.$t5.' '.$t6.' '.$t7.' '.$t8.' '.$t9.'';
  ...
  <tr background="../images/b_03.jpg" width="auto" height="auto">
              <td height="150"><div align="center"><table width="680" border="0" align="center">
                <tr>
        ';
    print '<td width="167" height="190"><div align="center">'."<img src='./foto/$logo' width='150' height='150'></div></td>";
...
if($num==0)
 { 
  ...
  <tr background="../images/b_02.jpg">
    ...
    print '<td width="510" valign="top"><p  class="style57"><span class="style52"><br />não possui nenhum estabelecimento cadastrado.</span></p>';
