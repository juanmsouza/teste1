...
<input type="checkbox" name="t2" value="exposicao" /> Exposição&nbsp;&nbsp;&nbsp;&nbsp;
...
<td width="auto"colspan="3"><div align="left">
<input type="checkbox" name="t5" value="jacarei" /> Jacareí&nbsp;
<input type="checkbox" name="t6" value="litoral" /> Litoral Norte
<input type="checkbox" name="t7" value="saojose" /> São José dos Campos<br />
<input type="checkbox" name="t8" value="taubate" /> Taubaté 
