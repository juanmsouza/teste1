...
$sqln = mysql_query("SELECT * FROM anuncio ORDER BY id DESC");
...
if($num == 0){
print "<td colspan='6'>";
print "<font color='#CCCCC'>Até o momento não temos nenhum evento cadastrado</font>";
print "<br /><br /></td>";
print "</tr>";
}else{
...
print "<tr>";
print "<td colspan='6'>";
print  "<font color='#CCCCC'>Temos ".$num."  evento cadastrados no site.</font>";
print "</td>";
print "</tr>";
print "<tr>";
print "<td colspan='7'>";
...
$sqln = mysql_query("SELECT * FROM anuncio ORDER BY id DESC LIMIT ".$inicio.",".$max."");
...
print '<a href="listagenda3.php?'. $_SERVER['QUERY_STRING']. "&pagina=".($pagina - 1).'"><< anterior</a>';
...
if ($total_paginas > 1){ 
    ...
    for ($i=1; $i <= $total_paginas; $i++){ 
       ...
       if ($pagina == $i){        
          ...
          echo "<a href=\"listagenda3.php?" . $_SERVER['QUERY_STRING']."&pagina=".$i."\">&nbsp;".$i."&nbsp;</a> "; 
...
print '<a href="listagenda3.php?'. $_SERVER['QUERY_STRING']. "&pagina=".($pagina + 1).'">próxima >></a>';
