...
if(isset($_POST['done'])){
	...
	if(!empty($nomefoto))
	{
       ...
       $sql = mysql_query("UPDATE evento SET t1='$t1', t2='$t2', t3='$t3', t4='$t4', t5='$t5', t6='$t6', t7='$t7', t8='$t8', t9='$t9', logo='$nomefoto', nome='$nome', local='$local', horario='$horario', data='$data', atracao='$atracao' WHERE id='$id'")or die(mysql_error());
	...
	else
	{
	       ...
	       $sql = mysql_query("UPDATE evento SET t1='$t1', t2='$t2', t3='$t3', t4='$t4', t5='$t5', t6='$t6', t7='$t7', t8='$t8', t9='$t9', nome='$nome', local='$local', horario='$horario', data='$data', atracao='$atracao' WHERE id='$id'")or die(mysql_error());
...
$sql = mysql_query("SELECT * FROM evento WHERE id = '$id'");
...
$atracao = @mysql_result($sql, 0, "atracao");
...
<form name="form1" action="atualagenda2.php" method="POST" style="padding-top:40px;" enctype="multipart/form-data">
<font color="#fffff">
<?php
...
<?PHP
 if($t1!="")
 {
   print'<input type="checkbox" name="t1" value="balada" checked /> Balada &nbsp;&nbsp;&nbsp;';
 }
 else
 {
   print'<input type="checkbox" name="t1" value="balada" /> Balada &nbsp;&nbsp;&nbsp;';
 }
 if($t2!="")
 {
   print'<input type="checkbox" name="t2" value="exposicao" checked /> Exposicao &nbsp;&nbsp;&nbsp;';
 }
 else
 {
   print'<input type="checkbox" name="t2" value="exposicao" /> Exposicao &nbsp;&nbsp;&nbsp;';
 }
  if($t3!="")
 {
   print'<input type="checkbox" name="t3" value="festa" checked /> Festa &nbsp;&nbsp;';
 }
 else
 {
   print'<input type="checkbox" name="t3" value="festa" /> Festa &nbsp;&nbsp;';
 }
  if($t4!="")
 {
   print'<input type="checkbox" name="t4" value="show" checked /> Show <br />';
 }
 else
 {
   print'<input type="checkbox" name="t4" value="show" /> Show<br />';
 }
 print'
 </td>
</tr>
...
<td width="auto"colspan="3"><div align="left">';
  if($t5!="")
 {
   print'<input type="checkbox" name="t5" value="jacarei" checked /> Jacareí &nbsp;&nbsp;&nbsp;&nbsp;';
 }
 else
 {
   print'<input type="checkbox" name="t5" value="jacarei" /> Jacareí &nbsp;&nbsp;&nbsp;';
 }
  if($t6!="")
 {
   print'<input type="checkbox" name="t6" value="litoral" checked /> Litoral Norte';
 }
 else
 {
   print'<input type="checkbox" name="t6" value="litoral" /> Litoral Norte';
 }
  if($t7!="")
 {
   print'<input type="checkbox" name="t7" value="saojose" checked /> São José dos Campos <br />';
 }
 else
 {
   print'<input type="checkbox" name="t7" value="saojose" /> São José dos Campos <br />';
 }
  if($t8!="")
 {
   print'<input type="checkbox" name="t8" value="taubate" checked /> Taubaté &nbsp;&nbsp;';
 }
 else
 {
   print'<input type="checkbox" name="t8" value="taubate" /> Taubaté &nbsp;&nbsp;';
 }
  if($t9!="")
 {
...
<div align="left">
<input type="text" name="data" value="<?PHP echo $data;?>" class="campo" id="data" size="5" maxlength="10"/>
</div></td>
</tr>
<tr>
...
<td width="auto"colspan="3">
<div align="left">
<input type="text" name="horario" value="<?PHP echo $horario;?>" class="campo" id="horario" size="5" maxlength="5"/>
</div></td>
</tr>

<tr>

<td valign="top"><div align="right">Atração: </div></td>
