...
<td>
  ...
  print '<td align="center"><font color="white">'.$evento.'</font></td>';
  print '<td align="center"><font color="white">'.$devento.'/'.$mevento.'/'.$aevento.'</font></td>';
  print '<td align="center"><font color="white">'.$hora.':'.$minuto.'</font></td>';
  print '<td align="center"><font color="white">'.$local.'</font></td>';
  print '<td align="center"><font color="white">'.$conteudo.'</font></td>';
