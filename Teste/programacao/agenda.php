...
<table width="900" border="0" bordercolor="#FFFFFF" align="center" bgcolor="#000000"> 
 <font color="#fffff"> <tr> 
    <td height="200" colspan="6" valign="middle"><img src="images/LOGO.png" /></td> 
...
if($num == 0){
print "<td colspan='6'>";
print "<font color='#CCCCC'>Até o momento não temos nenhum estabelecimento cadastrado</font>";
print "<br /><br /></td>";
print "</tr>";
}else{
...
print "<tr>";
print "<td colspan='6'>";
print  "<font color='#CCCCC'>Temos ".$num."  estabelecimento cadastrados no site.</font>";
print "</td>";
print "</tr>";
print "<tr>";
print "<td colspan='7'>";
...
?>
  ...
  <tr>
    ...
    <td width="5%" align="center" bgcolor="#202020" ><font color="#0ed30e">Logo</font></td>
    <td width="15%" align="center" bgcolor="#202020" ><font color="#0ed30e">Nome</font></td>
	<td width="15%" align="center" bgcolor="#202020" ><font color="#0ed30e">Local</font></td>
	<td width="15%" align="center" bgcolor="#202020" ><font color="#0ed30e">Horario</font></td>
	<td width="15%" align="center" bgcolor="#202020" ><font color="#0ed30e">Telefone</font></td>
	<td width="28%" align="center" bgcolor="#202020" ><font color="#0ed30e">Especialidade</font></td>
  ...
  print '<tr bgcolor='.$cor.'>';
	...
	print '<td align="center"><font color="white">'.$horario." as ".$horario2.'</font></td>';
	print '<td align="center"><font color="white">'.$tel.'</font></td>';
	print '<td align="center"><font color="white">'.$espec.'</font></td>';
   print '</tr>';
  print '<tr><td></td></tr>';
